...
\label{sec:arch}
Peers in the Libri network are called Librarians, and clients of these peers are called Authors. Librarians are responsible for the following:
\begin{itemize}
...
\begin{figure}[thp]
	...
	\caption{Diagram of essential document components and relationships.}
	\label{fig:documents}
\end{figure}
