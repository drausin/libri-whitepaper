...
\def\Publication{\ttt{Publteication}}
\def\Put{\ttt{Put}}
\def\Get{\ttt{Get}}
...
Inexorably, large organizations across all domains are becoming more adapt at creating, collecting, and processing data relevant to their operations in search of valuable insights. Increasingly, these enterprises are looking to pool their data to enhance its analytical value, solve collective action problems, and provide more comprehensive understandings of system-wide events. These nascent data consortiums are emerging among financial institutions (for instance, in support of anti-money laundering activities), educational institutions, and also within the healthcare sector.

It is notable, that participation in these collaborative data schemes affords benefit to the enterprise operators (albeit not directly monetary) in the form of simplified access to additional valuable data (at lower operational cost but with increased analytical potential), or by the ability to add enhanced value-add services to their customers via the comprehensive data reach (e.g., data portals).
